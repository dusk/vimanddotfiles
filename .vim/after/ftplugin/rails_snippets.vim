...
exec "Snippet <head <head><CR>".st.et."<CR></head><CR>".st.et
exec "Snippet <body <body><CR>".st.et."<CR></body>"
exec "Snippet <p <p>".st.et."</p><CR>".st.et
exec "Snippet <h1 <h1>".st.et."</h1><CR>".st.et
exec "Snippet <h2 <h2>".st.et."</h2><CR>".st.et
exec "Snippet <h3 <h3>".st.et."</h3><CR>".st.et
exec "Snippet <h4 <h4>".st.et."</h4><CR>".st.et
exec "Snippet <h5 <h5>".st.et."</h5><CR>".st.et
exec "Snippet <h6 <h6>".st.et."</h6><CR>".st.et
exec "Snippet <ul <ul><CR>".st.et."<CR></ul>"
exec "Snippet <li <li>".st.et."</li>".st.et
exec "Snippet href <a href=\"".st.et."\">".st.et."</a>"
exec "Snippet # <%# ".st.et." %>"

" rails
exec "Snippet li <%= ".st.et." %>"
exec "Snippet lirp <%= render :partial => \"".st.et."\" %>"
